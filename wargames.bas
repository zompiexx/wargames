...
360 IF H$="Y" THEN F$="INTRO.TXT":GOSUB 7240:ELSE:GOTO 380
370 IF H$="Y" THEN F$="IMSAI.TXT":GOSUB 7240:ELSE:GOTO 380
380 PRINT CLS$
...
660 IF H$="Y" AND GRADE$(1)<>"F" AND GRADE$(2)<>"F" THEN F$="GRADES.TXT":GOSUB 7240
670 GOTO 380
...
2340 PRINT CLS$
2350 IF H$="Y" AND HITS%>0 THEN F$="DIALER.TXT":GOSUB 7240
2360 GOTO 1390
2370 PRINT CLS$
...
2530 IF RESPONSE$="A" OR RESPONSE$="a" THEN GOSUB 7400:GOTO 2370
2540 IF SF%=1 THEN 2700
2550 IF RESPONSE$="B" OR RESPONSE$="b" THEN GOSUB 7400:GOTO 2370
2560 IF SF%=2 THEN 2700
2570 IF RESPONSE$="C" OR RESPONSE$="c" THEN 2710
2580 IF SF%=3 THEN 2700
2590 IF RESPONSE$="D" OR RESPONSE$="d" THEN GOSUB 7400:GOTO 2370
2600 IF SF%=4 THEN 2700
2610 IF RESPONSE$="E" OR RESPONSE$="e" THEN GOSUB 7400:GOTO 2370
2620 IF SF%=5 THEN 2700
2630 IF RESPONSE$="F" OR RESPONSE$="f" THEN 2840
2640 IF SF%=6 THEN 2700
2650 IF RESPONSE$="G" OR RESPONSE$="g" THEN GOSUB 7400:GOTO 2370
2660 IF SF%=7 THEN 2700
2670 IF RESPONSE$="H" OR RESPONSE$="h" THEN GOSUB 7400:GOTO 2370
...
4350 IF JOSHUA$="TICTACTOE" OR JOSHUA$="tictactoe" THEN 7440
...
5620 PRINT CLS$
5630 IF H$="Y" THEN F$="WOPR1.TXT":GOSUB 7240
5640 T$="--CONNECTION TERMINATED--":GOSUB 5470:PRINT
5650 FOR W%=1 TO D%*100:NEXT W%
5660 PRINT CLS$
5670 IF H$="Y" THEN F$="WOPR2.TXT":GOSUB 7240
...
5750 IF MID$(JOSHUA$,A%,9)="incorrect" OR MID$(JOSHUA$,A%,9)="INCORRECT" THEN 5770:ELSE:PRINT:GOTO 4270
5760 NEXT A%
5770 PRINT:T$="I'M SORRY TO HEAR THAT, PROFESSOR.":GOSUB 5470:PRINT:PRINT
5780 T$="YESTERDAY'S GAME WAS INTERRUPTED.":GOSUB 5470:PRINT:PRINT
5790 T$="ALTHOUGH PRIMARY GOAL HAS NOT YET":GOSUB 5470:PRINT
5800 T$="BEEN ACHIEVED, SOLUTION IS NEAR.":GOSUB 5470:PRINT:PRINT
5810 INPUT "", JOSHUA$
5820 FOR A%=1 TO LEN(JOSHUA$)
5830 IF MID$(JOSHUA$,A%,4)="what" OR MID$(JOSHUA$,A%,4)="WHAT" THEN 5850:ELSE:PRINT:GOTO 4270
5840 NEXT A%
5850 PRINT:T$="YOU SHOULD KNOW PROFESSOR. ":GOSUB 5470:FOR W%=1 TO D%*20:NEXT W%:T$="YOU PROGRAMMED ME.":GOSUB 5470:PRINT:PRINT
5860 INPUT "",JOSHUA$
5870 FOR A%=1 TO LEN(JOSHUA$)
5880 IF MID$(JOSHUA$,A%,4)="what" OR MID$(JOSHUA$,A%,4)="WHAT" THEN 5900:ELSE:PRINT:GOTO 4270
5890 NEXT A%
5900 PRINT:T$="TO WIN THE GAME.":GOSUB 5470:PRINT:PRINT
5910 FOR W%=1 TO D%*200:NEXT W%:PRINT CLS$
5920 GTE%=0:ETR%=10
5930 FOR GC%=1 TO 10
5940 GTE%=GTE%+1:ETR%=ETR%-1
5950 PRINT CLS$
5960 FOR A%=1 TO 15:PRINT:NEXT A%
5970 FOR A%=1 TO 80:PRINT "_";:NEXT A%
5980 PRINT:PRINT
5990 PRINT TAB(10);"GAME TIME ELAPSED";:PRINT TAB(50);"ESTIMATED TIME REMAINING"
6000 PRINT TAB(10);"31 HRS 12 MIN ";GTE%;" SEC";:PRINT TAB(50);"52 HRS 17 MIN ";ETR%;" SEC"
6010 FOR A%=1 TO 80:PRINT "_";:NEXT A%
6020 PRINT
6030 FOR W%=1 TO D%*25:NEXT W%
6040 NEXT GC%
6050 PRINT:PRINT
6060 T$="--CONNECTION TERMINATED--":GOSUB 5470:PRINT
6070 FOR W%=1 TO D%*25:NEXT W%
6080 PRINT CLS$
6090 IF H$="Y" THEN F$="NORAD.TXT":GOSUB 7240
6100 PRINT CLS$
6110 PRINT "TRZ. 34/53/76               SYS PROC 3435.45.6456           XCOMP STATUS: PV-456"
6120 PRINT "ACTIVE PORTS: 34,53,75,94                                     CPU TM USED: 23:43"
6130 PRINT "#45/34/53.           ALT MODE FUNCT: PV-8-AY345              STANDBY MODE ACTIVE"
6140 PRINT "#543.654      #989.283       #028.392       #099.293      #934.905      #261.372"
6150 PRINT
6160 INPUT "LOGON: ",JOSHUA$
6170 IF JOSHUA$="JOSHUA" OR JOSHUA$="joshua" THEN 6180:ELSE:T$="IDENTIFICAION NOT RECOGNIZED BY SYSTEM":GOSUB 5470:FOR W%=1 TO D%*25:NEXT W%:GOTO 6100
6180 PRINT CLS$:FOR W%=1 TO D%*25:NEXT W%:T$="GREETINGS PROFESSOR FALKEN.":GOSUB 5470:PRINT:PRINT
6190 INPUT "",JOSHUA$
6200 FOR A%=1 TO LEN(JOSHUA$)
6210 IF MID$(JOSHUA$,A%,5)="STILL" OR MID$(JOSHUA$,A%,5)="still" THEN PRINT:GOTO 6240
6220 NEXT A%
6230 PRINT:GOTO 6190
6240 T$="OF COURSE. ":GOSUB 5470:FOR W%=1 TO D%*25:NEXT W%:T$="I SHOULD REACH DEFCON 1 AND":GOSUB 5470:PRINT:T$="LAUNCH MY MISSILES IN 28 HOURS.":GOSUB 5470:PRINT:PRINT
6250 FOR W%=1 TO D%*50:NEXT W%
6260 T$="WOULD YOU LIKE TO SEE SOME PROJECTED KILL RATIOS?":GOSUB 5470:PRINT:PRINT
6270 FOR W%=1 TO D%*25:NEXT W%
6280 T$="UNITED STATES                                      SOVIET UNION":GOSUB 5470:PRINT
6290 T$="UNITS DESTROYED          MILITARY ASSETS           UNITS DESTROYED":GOSUB 5470:PRINT
6300 FOR A%=1 TO 80:PRINT "_";:NEXT A%
6310 T$="     60%                 BOMBERS                         48%":GOSUB 5470:PRINT
6320 T$="     54%                 ICBM                            51%":GOSUB 5470:PRINT
6330 T$="     12%                 ATTACK SUBS                     23%":GOSUB 5470:PRINT
6340 T$="     39%                 TACTICAL AIRCRAFT               46%":GOSUB 5470:PRINT
6350 T$="     50%                 GROUND FORCES                   52%":GOSUB 5470:PRINT
6360 PRINT:PRINT
6370 T$="UNITED STATES                                      SOVIET UNION":GOSUB 5470:PRINT
6380 T$="UNITS DESTROYED          CIVILIAN ASSETS           UNITS DESTROYED":GOSUB 5470:PRINT
6390 FOR A%=1 TO 80:PRINT "_";:NEXT A%
6400 T$="     60%                 HOUSING                         56%":GOSUB 5470:PRINT
6410 T$="     22%                 COMMUNICATIONS                  37%":GOSUB 5470:PRINT
6420 T$="     45%                 TRANSPORTATION                  41%":GOSUB 5470:PRINT
6430 T$="     70%                 FOOD STOCKPILES                 82%":GOSUB 5470:PRINT
6440 T$="     89%                 HOSPITALS                       91%":GOSUB 5470:PRINT
6450 PRINT:PRINT
6460 T$="UNITED STATES            HUMAN RESOURCES           SOVIET UNION":GOSUB 5470:PRINT
6470 FOR A%=1 TO 80:PRINT "_";:NEXT A%
6480 T$="49 MILLION               NON-FATAL INJURED         51 MILLION":GOSUB 5470:PRINT
6490 T$="72 MILLION               POPULATION DEATHS         75 MILLION":GOSUB 5470:PRINT
6500 PRINT
6510 INPUT "",JOSHUA$
6520 FOR A%=1 TO LEN(JOSHUA$)
6530 IF MID$(JOSHUA$,A%,4)="REAL" OR MID$(JOSHUA$,A%,4)="real" THEN 6560
6540 NEXT A%
6550 PRINT:GOTO 6510
6560 PRINT:T$="WHAT'S THE DIFFERENCE?":GOSUB 5470:PRINT:PRINT
6570 FOR W%=1 TO D%*25:NEXT W%
6580 T$="YOU ARE A HARD MAN TO REACH. COULD NOT FIND":GOSUB 5470:PRINT
6590 T$="YOU IN SEATTLE AND NO TERMINAL IS IN":GOSUB 5470:PRINT
6600 T$="OPERATION AT YOUR CLASSIFIED ADDRESS.":GOSUB 5470:PRINT:PRINT
6610 INPUT "",JOSHUA$
6620 FOR A%=1 TO LEN(JOSHUA$)
6630 IF MID$(JOSHUA$,A%,7)="ADDRESS" OR MID$(JOSHUA$,A%,7)="address" THEN 6660
6640 NEXT A%
6650 PRINT:GOTO 6610
6660 PRINT:T$="DOD PENSION FILES INDICATE":GOSUB 5470:PRINT
6670 T$="CURRENT MAILING AS:":GOSUB 5470:PRINT:PRINT
6680 T$="DR. ROBERT HUME (A.K.A. STEPHEN W. FALKEN)":GOSUB 5470:PRINT
6690 T$="5 TALL CEDAR ROAD":GOSUB 5470:PRINT
6700 T$="GOOSE ISLAND, OREGON 97014":GOSUB 5470:PRINT:PRINT
6710 FOR W%=1 TO D%*250:NEXT W%
6720 IF H$="Y" THEN F$="OFFICE.TXT":GOSUB 7240
6730 IF H$="Y" THEN F$="FALKEN1.TXT":GOSUB 7240
6740 IF H$="Y" THEN F$="FALKEN2.TXT":GOSUB 7240
6750 FOR A%=1 TO 5
6760 PRINT CLS$
6770 PRINT "                         MISSILES TARGETED AND READY"
6780 PRINT "                         ---------------------------"
6790 PRINT:PRINT:PRINT
6800 IF A%=1 OR A%=3 OR A%=5 THEN PRINT "                             CHANGES LOCKED OUT":ELSE:PRINT
6810 PRINT "                             ------------------"
6820 FOR W%=1 TO D%*25:NEXT W%
6830 NEXT A%
6840 FOR W%=1 TO D%*250:NEXT W%
6850 PRINT CLS$
6860 PRINT "                            PRIMARY TARGET IMPACT"
6870 PRINT "                            ---------------------"
6880 PRINT
6890 PRINT "                    LORING AIRFORCE BASE      : ";:FOR W%=1 TO 1000:NEXT W%:PRINT "NO IMPACT"
6900 PRINT "                    ELMENDORF AIRFORCE BASE   : ";:FOR W%=1 TO 1000:NEXT W%:PRINT "NO IMPACT"
6910 PRINT "                    GRAND FORKS AIRFORCE BASE : ";:FOR W%=1 TO 1000:NEXT W%:PRINT "NO IMPACT"
6920 PRINT:PRINT
6930 INPUT "                          Press 'ENTER' key to CONTINUE",RESPONSE$
6940 IF H$="Y" THEN F$="MISSILES.TXT":GOSUB 7240
6950 LC$="CPE1704TKS"
6960 LC%=0
6970 FOR A%=1 TO LEN(LC$)
6980 PRINT CLS$:FOR B%=1 TO 10:PRINT:NEXT B%:FOR B%=1 TO 30:PRINT " ";:NEXT B%
6990 FOR B%=1 TO LC%:PRINT MID$(LC$,B%,1)+" ";:NEXT B%:FOR B%=1 TO LEN(LC$)-LC%:PRINT "- ";: NEXT B%
7000 LCG%=RND(1)*1000
7010 IF LCG%<48 OR LCG%>90 GOTO 7000
7020 IF LCG%>57 AND LCG%<65 GOTO 7000
7030 PRINT CLS$:FOR B%=1 TO 10:PRINT:NEXT B%: FOR B%=1 TO 30:PRINT " ";:NEXT B%
7040 FOR B%=1 TO LC%:PRINT MID$(LC$,B%,1)+" ";:NEXT B%:PRINT CHR$(LCG%)+" ";:FOR B%=1 TO LEN(LC$)-LC%-1:PRINT "- ";:NEXT B%:PRINT
7050 IF CHR$(LCG%)=MID$(LC$,A%,1) THEN 7060:ELSE:GOTO 7000
7060 PRINT CLS$:FOR B%=1 TO 10:PRINT:NEXT B%:FOR B%=1 TO 30:PRINT " ";:NEXT B%
7070 LC%=LC%+1:FOR B%=1 TO LC%:PRINT MID$(LC$,B%,1)+" ";:NEXT B%:FOR B%=1 TO LEN(LC$)-LC%:PRINT "- ";:NEXT B%
7080 NEXT A%
7090 FOR A%=1 TO 9
7100 PRINT CLS$:FOR B%=1 TO 9:PRINT:NEXT B%
7110 FOR B%=1 TO 30:PRINT " ";:NEXT B%:FOR B%=1 TO 20:PRINT "-";:NEXT B%:PRINT
7120 FOR B%=1 TO 30:PRINT " ";:NEXT B%:IF A%=1 OR A%=3 OR A%=5 OR A%=7 OR A%=9 THEN FOR B%=1 TO LEN(LC$):PRINT MID$(LC$,B%,1);" ";:NEXT B%:PRINT:ELSE:PRINT
7130 FOR B%=1 TO 30:PRINT " ";:NEXT B%:FOR B%=1 TO 20:PRINT "-";:NEXT B%:PRINT
7140 FOR W%=1 TO 1000:NEXT W%
7150 NEXT A%
7160 FOR W%=1 TO 1000:NEXT W%
7170 PRINT:PRINT:PRINT TAB(20);"IT'S GOT THE CODE,";:FOR W%=1 TO 1000:NEXT W%:PRINT " IT'S GOING TO LAUNCH!"
7180 PRINT
7190 INPUT "                          Press 'ENTER' key to CONTINUE",RESPONSE$
7200 ENDGAME%=1
7210 GOTO 7440
7220 PRINT CLS$: PRINT CLS$:T$="A STRANGE GAME. ":GOSUB 5470:FOR W%=1 TO D%*25:NEXT W%:T$="THE ONLY WINNING MOVE IS NOT TO PLAY!":GOSUB 5470:PRINT:PRINT
7230 END
7240 PRINT CLS$
7250 PRINT "                           WOPR ( Wargames ) Simulator"
7260 PRINT "                           War Operation Plan Response"
7270 PRINT
7280 OPEN"I",1,F$
7290 COUNT%=1
7300 IF EOF(1) THEN 7350
7310 PRINT INPUT$(1,#1);
7320 COUNT%=COUNT%+1
7330 IF COUNT%=80 THEN COUNT%=0:PRINT
7340 GOTO 7300
7350 CLOSE
7360 PRINT:PRINT
7370 INPUT "                          Press 'ENTER' key to CONTINUE",RESPONSE$
7380 PRINT CLS$
7390 RETURN
7400 FOR W%=1 TO D%*25:NEXT W%:PRINT CLS$
7410 PRINT "DIALING";:GOSUB 5460
7420 PRINT "ERROR 676   LINE BUSY":FOR W%=1 TO D%*40:NEXT W%:PRINT CLS$
7430 RETURN
7440 PRINT CLS$
7450 PRINT "The Grid is Numbered"
7460 PRINT
7470 PRINT " 1 ! 2 ! 3 "
7480 PRINT "---+---+---"
7490 PRINT " 4 ! 5 ! 6 "
...
7510 PRINT " 7 ! 8 ! 9 "
7520 PRINT
7530 INPUT "PRESS 'ENTER' KEY TO CONTINUE",RESPONSE$:PRINT CLS$
7540 FOR R=1 TO 9:A(R)=0:NEXT R
7550 PRINT"Who goes first (ME or YOU): ";
7560 LINE INPUT A$
7570 IF MID$(A$,1,1)="Y" OR MID$(A$,1,1)="y" THEN QE=1:P$=" OX":GOTO 7960
7580 PRINT"Do you want 'X' or 'O':";:LINE INPUT M$
7590 IF M$="o" OR M$="O" THEN P$=" OX" ELSE P$=" XO"
7600 GOTO 7960
7610 REM Here is where somebody wins!!
7620 W=0:FOR E=1 TO 2:FOR X=1 TO 8:ON X GOTO 7630,7640,7650,7660,7670,7680,7690,7700
7630 J=1:K=2:L=3:GOTO 7710
7640 J=1:K=5:L=9:GOTO 7710
7650 J=3:K=5:L=7:GOTO 7710
7660 J=4:K=5:L=6:GOTO 7710
7670 J=7:K=8:L=9:GOTO 7710
7680 J=1:K=4:L=7:GOTO 7710
7690 J=2:K=5:L=8:GOTO 7710
7700 J=3:K=6:L=9
7710 IF A(J)=E AND A(K)=E AND A(L)=E THEN 7730
7720 NEXT X:NEXT E:W=0:GOTO 7740
7730 W=E:RETURN
7740 FOR E=1 TO 0:NEXT E:FOR X=1 TO 0:NEXT X
7750 FOR I=1 TO 9
7760 IF A(I)=0 THEN 7780
7770 NEXT I:W=-1:RETURN
7780 FOR I=1 TO 0:NEXT I:W=0:RETURN
7790 Z=0:IF A(M)<>0 THEN Z=1:RETURN ELSE RETURN
7800 REM Find a good move
7810 M=0:FOR E=2 TO 1 STEP -1:FOR X=1 TO 8:ON X GOTO 7820,7830,7840,7850,7860,7870,7880,7890
7820 J=1:K=2:L=3:GOTO 7900
7830 J=1:K=5:L=9:GOTO 7900
7840 J=3:K=5:L=7:GOTO 7900
7850 J=4:K=5:L=6:GOTO 7900
7860 J=7:K=8:L=9:GOTO 7900
7870 J=1:K=4:L=7:GOTO 7900
7880 J=2:K=5:L=8:GOTO 7900
7890 J=3:K=6:L=9
7900 IF A(J)=E AND A(K)=E THEN M=L:GOSUB 7790:IF Z=0 THEN 7950
7910 IF A(K)=E AND A(L)=E THEN M=J:GOSUB 7790:IF Z=0 THEN 7950
7920 IF A(J)=E AND A(L)=E THEN M=K:GOSUB 7790:IF Z=0 THEN 7950
7930 NEXT X:NEXT E:REM No good move found, pick one!
7940 M=INT(9*RND(1)+1):IF A(M)<>0 THEN 7940 ELSE RETURN
7950 FOR X=1 TO 0:NEXT X:FOR E=1 TO 2:NEXT E:RETURN
7960 A$="---+---+---"
7970 IF QE=1 THEN QE=0:GOTO 8070:ELSE 8020
7980 PRINT CLS$
7990 I=1:PRINT " "+MID$(P$,A(I)+1,1)+" ! "+MID$(P$,A(I+1)+1,1)+" ! "+MID$(P$,A(I+2)+1,1)+" ":PRINT A$
8000 I=4:PRINT " "+MID$(P$,A(I)+1,1)+" ! "+MID$(P$,A(I+1)+1,1)+" ! "+MID$(P$,A(I+2)+1,1)+" ":PRINT A$
8010 I=7:PRINT " "+MID$(P$,A(I)+1,1)+" ! "+MID$(P$,A(I+1)+1,1)+" ! "+MID$(P$,A(I+2)+1,1)+" ":RETURN
8020 GOSUB 7980:PRINT
8030 PRINT"Where do you move (1-9):";:INPUT M
8040 IF M<1 OR M>9 THEN PRINT:PRINT"Illegal square location!":PRINT:GOTO 8030
8050 IF A(M)<>0 THEN PRINT:PRINT"Square occupied!":PRINT:GOTO 8030
8060 A(M)=1
8070 GOSUB 7610:IF W<>0 THEN 8100
8080 PRINT"Hm......";:GOSUB 7800
8090 A(M)=2:PRINT"I move ";M:GOSUB 7610:IF W<>0 THEN 8100 ELSE GOTO 8020
8100 IF W=-1 THEN PRINT:PRINT"That was a tie game."
8110 IF W=1 THEN PRINT:PRINT"You win."
8120 IF W=2 THEN PRINT:PRINT"Ha-Ha!! I win!!":PRINT"Don't you know that you can't beat a computer!"
8130 PRINT:PRINT"Do you want to try again (Y/N):";
8140 LINE INPUT F$
8150 IF MID$(F$,1,1)="N" OR MID$(F$,1,1)="n" THEN 8160:ELSE:FOR R=1 TO 9:A(R)=0:NEXT R:GOTO 7440
8160 PRINT"BYE!!!"
8170 FOR W%=1 TO D%*20:NEXT W%
8180 IF ENDGAME%=1 THEN 7220
8190 PRINT CLS$:GOTO 4260
